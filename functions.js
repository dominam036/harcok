const th_hm_value = "Harc megnevezése";//th_hm valuejának megadása
const th_szf_value = "Szembenálló felek";//th_szf valuejának megadása
const th_hr_value = "Haderő";//th_hr valuejának megadása

const td_hm_value = "Rákóczi szabadságharc";//td_hm valuejának megadása
const td_szf_value = "Kuruc";//td_szf valuejának megadása
const td_hr_value = "70.000";//td_hr valuejának megadása

const td_szf2_value = "Labanc";//td_hm2 valuejának megadása
const td_hr2_value = "60.000";//td_hr2 valuejának megadása

const td_hm3_value = "48-as szabadságharc";//td_hm3 valuejának megadása
const td_szf3_value = "Osztrák császárság (+ Orosz birodalom)";//td_szf3 valuejának megadása
const td_hr3_value = "170.000 (+ 200.000)";//td_hr3 valuejának megadása

const td_szf4_value = "Magyar királyság";//td_hm4 valuejának megadása
const td_hr4_value = "170.000";//td_hr4 valuejának megadása

const td_hm5_value = "I. világháború";//td_hm5 valuejának megadása
const td_szf5_value = "Antant";//td_szf5 valuejának megadása
const td_hr5_value = "43 millió";//td_hr5 valuejának megadása

const td_szf6_value = "Központi hatalmak";//td_hm6 valuejának megadása
const td_hr6_value = "25 millió";//td_hr6 valuejának megadása

const td_hm7_value = "Bosworthi csata";//td_hm7 valuejának megadása
const td_szf7_value = "Angolok (York + Lancester)";//td_szf7 valuejának megadása
const td_hr7_value = "15.000";//td_hr7 valuejának megadása
...
td_szf2.innerHTML = td_szf2_value;//td_szf2 szövegének megadása változóval
...
td_hr2.innerHTML = td_hr2_value;//td_hr2 szövegének megadása változóval
...
td_szf3.innerHTML = td_szf3_value;//td_szf3 szövegének megadása változóval
...
td_hm3.innerHTML = td_hm3_value;//td_hm3 szövegének megadása változóval
...
td_hr3.innerHTML = td_hr3_value;//td_hr3 szövegének megadása változóval
...
td_szf4.innerHTML = td_szf4_value;//td_szf4 szövegének megadása változóval
...
td_hr4.innerHTML = td_hr4_value;//td_hr4 szövegének megadása változóval
...
td_szf5.innerHTML = td_szf5_value;//td_szf5 szövegének megadása változóval
...
td_hm5.innerHTML = td_hm5_value;//td_hm5 szövegének megadása változóval
...
td_hr5.innerHTML = td_hr5_value;//td_hr5 szövegének megadása változóval
...
td_szf6.innerHTML = td_szf6_value;//td_szf6 szövegének megadása változóval
...
td_hr6.innerHTML = td_hr6_value;//td_hr6 szövegének megadása változóval
...
td_szf7.innerHTML = td_szf7_value;//td_szf7 szövegének megadása változóval
...
td_hm7.innerHTML = td_hm7_value;//td_hm7 szövegének megadása változóval
...
td_hr7.innerHTML = td_hr7_value;//td_hr7 szövegének megadása változóval
